...
const SelectMultiple = ({ element }) => {
  ...
  // ✅ Extract dependencies from choice_filter expression
  ...
  // ✅ Available options - depends on choiceFilterVersion to re-evaluate when dependencies change
  const availableOptions = useMemo(() => {
    // Force re-evaluation when choiceFilterVersion changes
    const _ = choiceFilterVersion;
